...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        @else
            <ul class="nav navbar-right top-nav">
                <li>
                    <a href="{{ route('login') }}" data-placement="bottom" data-toggle="tooltip" href="#" data-original-title="Stats">Login</a>
                </li>
                <li class="dropdown">
                    <a href="{{ route('register') }}" data-placement="bottom" data-toggle="tooltip" href="#" data-original-title="Stats">Register</a>
                </li>
            </ul>
        @endif
    </nav>
